	...
	if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
		var a = {
			...
			data: {
				...
				datasets: [{
					data: [15, 20, 30, 10, 30],
					backgroundColor: ["#7ecc12", "#5d96fc", "#fe9b4a", "#45c6fc", "#11d7eb"],
					hoverBackgroundColor: ["#6db40a", "#2b65cd", "#de6d11", "#039dde", "#07b1bc"]
				}]
			},
			options: {
				legend: !1,
...
function init_sparklines() {
	"undefined" != typeof jQuery.fn.sparkline && (console.log("init_sparklines"), $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
		...
		height: "50",
		lineColor: "#26B99A",
		fillColor: "rgba(223, 223, 223, 0.37)",
		lineWidth: 2,
		spotColor: "#fe9b4c",
		minSpotColor: "#26B99A"
	...
	if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
		...
		if ($("#canvas_line4").length) {
			new Chart(document.getElementById("canvas_line4"), {
				...
				data: {
					...
					datasets: [{
						label: "产品部",
						backgroundColor: "rgba(102, 204, 0, 0)",
						borderColor: "rgba(102, 204, 0,  1)",
						borderWidth: 2,
						pointBorderColor: "rgba(102, 204, 0, 0.7)",
						pointBackgroundColor: "rgba(102, 204, 0,  1)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(102, 204, 0,1)",
						pointBorderWidth: 1,
						data: [31, 74, 6, 39, 20, 85, 7]
					}, {
						label: "技术部",
						...
						borderWidth: 2,
						pointBorderColor: "rgba(51, 102, 255, 0.70)",
						...
						borderWidth: 2,
						pointBorderColor: "rgba(255, 102, 0, 0.70)",
						pointBackgroundColor: "rgba(255, 102, 0, 1)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(255, 102, 0,1)",
						pointBorderWidth: 1,
						data: [34, 54, 46, 20, 45, 31, 10]
					} , {
						label: "调度协调部",
						backgroundColor: "rgba(51, 153, 204, 0)",
						borderColor: "rgba(51, 153, 204, 1)",
						borderWidth: 2,
						pointBorderColor: "rgba(51, 153, 204, 0.70)",
						pointBackgroundColor: "rgba(51, 153, 204, 1)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(51, 153, 204,1)",
						pointBorderWidth: 1,
						data: [55, 67, 32, 34, 60, 43, 48]
					}, {
						label: "市场运营部",
						backgroundColor: "rgba(0, 204, 204, 0)",
						borderColor: "rgba(0, 204, 204, 1)",
						borderWidth: 2,
						pointBorderColor: "rgba(0, 204, 204, 0.70)",
						pointBackgroundColor: "rgba(0, 204, 204, 1)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(0, 204, 204, 1)",
						pointBorderWidth: 1,
						data: [12, 40, 88, 43, 98, 23, 56]
					}]
				}
			})
		}
		if ($("#lineChart").length) {
			...
			new Chart(f, {
				...
				data: {
					...
					datasets: [{
						label: "My First dataset",
						backgroundColor: "rgba(45, 192, 251, 0.25)",
						borderColor: "rgba(45, 192, 251, 0.99)",
						borderWidth: 1, 
						pointBorderColor: "rgba(45, 192, 251, 0.6)",
						pointBackgroundColor: "rgba(45, 192, 251, 1)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(45, 192, 251, 1)",
						pointBorderWidth: 2,
						data: [31, 74, 6, 39, 20, 85, 7]
					}, {
						label: "My Second dataset",
						backgroundColor: "rgba(254, 153, 71, 0.25)",
						borderColor: "rgba(254, 153, 71, 0.99)",
						borderWidth: 1,
						pointBorderColor: "rgba(254, 153, 71, 0.60)",
						pointBackgroundColor: "rgba(254, 153, 71, 0.99)",
						pointHoverBackgroundColor: "#fff",
						pointHoverBorderColor: "rgba(254, 153, 71, 0.99)",
						pointBorderWidth: 2,
						data: [82, 23, 66, 9, 99, 4, 2]
					}]
				}
		...
		if ($("#mybarChart").length) {
			...
			new Chart(f, {
				type: "bar",
				data: {
					labels: ["技术部", "产品部", "宣传部", "综合部", "市场部", "运维部", "测试部"],
					datasets: [{
						label: "# 汽油（92#）",
						backgroundColor: "#2dd4a6",
						data: [51, 30, 40, 28, 92, 50, 45]
					}, {
						label: "# 汽油（95#）",
						backgroundColor: "#5a95fc",
						data: [41, 56, 25, 48, 72, 34, 12]
					}
							  , {
						label: "# 柴油",
						backgroundColor: "#ff9966",
						data: [32, 47, 56, 76, 31, 55,32]
					}]
				},
				options: {
					scales: {
		...
		if ($("#pieChart").length) {
			var f = document.getElementById("pieChart"),
				i = {
					datasets: [{
						data: [120, 50, 140, 180],
						backgroundColor: ["#66cc00", "#6699ff", "#ff9933", "#33ccff"],
						label: "My dataset"
					}],
					labels: ["急加速", "急减速", "急转弯", "急刹车"]
				};
			new Chart(f, {
				data: i,
				type: "pie",
