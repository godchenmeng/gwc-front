(function(t, i, s, e) {
	...
	l.prototype = {
		...
		initStatus: function() {
			...
			this.sliderBtn.css({
				width: t.opts.height - 2,
				height: t.opts.height - 2,
				lineHeight: t.opts.height - 2 + "px"
			});
			this.bgColor.css({
				height: t.opts.height - 2,
		...
		sliderMousemove: function(i, e) {
			...
			t(s).on("mousemove.slider", function(t) {
				...
				l.bgColor.width(l.sliderBtn_left + l.sliderBtn.width()/2)
			})
		},
		sliderMouseup: function() {
			...
			t(s).on("mouseup.slider", function() {
				...
				i.bgColor.animate({
					width: i.sliderBtn_left + i.sliderBtn.width()/2
				}, i.opts.time);
