...
var ControlSearch = React.createClass({
    ...
    handleExportClick:function (event) {
        var param = ControlStore.data.controlSearchParam;
        ControlAction.export(param);
    },
    render: function () {
        return (
            <div className="search-box">
                <a data-status="1" onClick={this.handleChangeStatus}>待签收</a>
                <a data-status="2" onClick={this.handleChangeStatus}>反馈</a>
                <a data-status="3" onClick={this.handleChangeStatus}>待完成</a>
                <a data-status="4" onClick={this.handleChangeStatus}>已撤销</a>
                <a data-status="5" onClick={this.handleChangeStatus}>已完成</a>
