...
var FoulParkStore = Reflux.createStore({
    listenables: [FoulParkAction],
    data: {
        org_columns:[],
    ...
    /**
     * 响应Action seerch，违规停运统计搜索功能
     * @param {dataType} paramName  说明
     */
    onSearch: function(){
        $('#foul_park_table').bootstrapTable('refresh');
    },
    /**
     * 违规停运统计数据导出
    ...
    onExport: function(data){
        Urls.open(Urls.foulParkExport,data);
    },
});

export default FoulParkStore