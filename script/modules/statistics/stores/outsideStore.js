...
var OutsideStore = Reflux.createStore({
    listenables: [OutsideAction],
    data: {
        org_columns:[],
    ...
    /**
     * 响应Action seerch，越界统计搜索功能
     * @param {dataType} paramName  说明
     */
    onSearch: function(){
        $('#outside_table').bootstrapTable('refresh');
    },
    /**
     * 越界统计数据导出
    ...
    onExport: function(data){
        Urls.open(Urls.outsideExport,data);
    },
});
